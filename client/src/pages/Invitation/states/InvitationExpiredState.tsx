...
const InvitationExpiredState = ({ invitation }: InvitationExpiredStateProps) => {
    ...
    <InvitationLandingShell>
      <Column spacing={2} alignItems="center" sx={{ textAlign: 'center', width: '100%' }}>
        ...
        <Typography variant="h6" fontWeight={700}>
          {t('sharedHousehold.landing.expired.title')}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          {t('sharedHousehold.landing.expired.body', {
      ...
      >
        {t('sharedHousehold.landing.expired.backToApp')}
      </Button>
    </InvitationLandingShell>
  );
};

export default InvitationExpiredState;
